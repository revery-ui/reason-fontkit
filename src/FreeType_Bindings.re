...
/* external ft_init: unit => ft_return(ft_freetype) = "caml_ft_init"; */
...
/* /1* TODO: Cleanup! *1/ */
/* /1* external ft_done_char: (ft_character) =>  unit = "caml_ft_done_char"; *1/ */
/* /1* external ft_done_face: (ft_face) => unit = "caml_ft_done_face"; *1/ */
/* /1* external ft_done_freetype: (ft_freetype) => unit = "caml_ft_done_freetype" *1/ */
